...
namespace Acoustics.Test.AnalysisPrograms.Concatenation
{
    ...
    public class ConcatenationTests : OutputDirectoryTest
    {
        ...
        public void ConcatenateEverythingYouCanLayYourHandsOn()
        {
            ...
            Assert.That.PixelIsColor(new Point(200, 125), Color.FromRgb(60, 44, 255), actualImage);
        ...
        public void ConcatenateIndexFilesTest24Hour()
        {
            ...
            Assert.That.PixelIsColor(new Point(105, 154), Color.FromRgb(34, 30, 255), actualImage);
            Assert.That.PixelIsColor(new Point(100, 160), Color.FromRgb(0, 79, 132), actualImage);
        }
        ...
        public void ConcatenateIndexFilesTest24HourWithoutDateRange()
        {
            ...
            Assert.That.PixelIsColor(new Point(50, 50), Color.FromRgb(86, 27, 16), actualImage1);
