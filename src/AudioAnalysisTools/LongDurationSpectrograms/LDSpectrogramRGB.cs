...
namespace AudioAnalysisTools.LongDurationSpectrograms
{
    ...
    public class LDSpectrogramRGB
    {
        ...
        /// </summary>
        public Image<Rgb24> DrawFalseColourSpectrogramChromeless(string colorMode, string colorMap)
        {
        ...
        /// </summary>
        public static Image<Rgb24> FrameLDSpectrogram(Image<Rgb24> bmp1, Image<Rgb24> titleBar, LDSpectrogramRGB cs, int nyquist, int herzInterval)
        {
        ...
        /// </summary>
        public static Image<Rgb24> DrawRgbColourMatrix(double[,] redM, double[,] grnM, double[,] bluM, bool doReverseColour)
        {
